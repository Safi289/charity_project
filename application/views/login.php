...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url();?>assets/backend_asset/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url();?>formpost" method="post">
...
<!-- iCheck -->
<script src="<?php echo base_url();?>assets/backend_asset/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
