    	...
    	<div class="container">
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-5 d-flex">
    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(<?php echo base_url();?>assets/frontend_asset/images/about-1.jpg);">
    				</div>
    			</div>
    ...
    <section class="ftco-mission">
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-md-4 py-4 py-md-5 img" style="background-image: url(<?php echo base_url();?>assets/frontend_asset/images/bg_1.jpg)"></div>
    		</div>
    	</div>
    </section>
      ...
      <div class="container">
        <div class="row ftco-animate justify-content-center">
        	<div class="col-md-6 d-flex">
        		<div class="testimony-img" style="background-image: url(<?php echo base_url();?>assets/frontend_asset/images/testimony-img.png);"></div>
        	</div>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap pb-4">
                  ...
                  <div class="d-flex">
	                  <div class="user-img" style="background-image: url(<?php echo base_url();?>assets/frontend_asset/images/person_1.jpg)">
	                  </div>
	                  <div class="pos ml-3">
